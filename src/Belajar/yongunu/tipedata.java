...
public class tipedata {
    public static void main(String[] args) {
        ...
        System.out.println("nilai integer x = " + x);
        ...
        System.out.println("nilai integer c = " + c);
        ...
        System.out.println("nilai integer d = " + d);
        ...
        System.out.println("===TERMAKASIH===");
         ...
         char p = 'c';
        System.out.println("===FLOAT===");
        System.out.println("nilai integer p = " + p);
        ...
        System.out.println("===TERMAKASIH===");
         ...
         boolean kamu = true;
        System.out.println("===FLOAT===");
        System.out.println("nilai FLOAT d = " + kamu);
